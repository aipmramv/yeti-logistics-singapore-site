...
const WordPressEnquirySection = () => {
  const { toast } = useToast();
  const { data: companyInfo, loading: companyLoading } = useWordPressCompanyInfo();
...
This enquiry was submitted through the Yeti Logistics website contact form.
    ...
    // Get company email from WordPress or use fallback
    const contactEmail = companyInfo?.acf?.email || 'enquiry@yetilogistics.com';
    ...
    <section id="enquiry" className="py-20 bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          {!companyLoading && companyInfo?.acf && (
            <div className="mt-8 text-center text-gray-600">
              <p className="mb-2">
                <strong>{companyInfo.acf.name}</strong>
              </p>
              <p className="whitespace-pre-line mb-2">{companyInfo.acf.address}</p>
              <p className="mb-1">
                <strong>Phone:</strong> {companyInfo.acf.phone}
              </p>
              <p>
                <strong>Email:</strong> {companyInfo.acf.email}
              </p>
            </div>
          )}
        </div>
...
export default WordPressEnquirySection;
