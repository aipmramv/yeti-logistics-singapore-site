...
import { useAboutInfo } from '@/hooks/useAppwriteContent';
...
const AppwriteAboutSection = () => {
  const { data: aboutContent, loading, error } = useAboutInfo();
...
export default AppwriteAboutSection;
