    ...
    const { error } = await supabase
      ...
      await fetch('/api/send-email', {
        ...
        body: JSON.stringify({
          ...
          html: `<p><strong>Name:</strong> ${formData.name}</p><p><strong>Email:</strong> ${formData.email}</p><p><strong>Phone:</strong> ${formData.phone}</p><p><strong>Company:</strong> ${formData.company}</p><p><strong>Service Type:</strong> ${formData.service_type}</p><p><strong>Message:</strong> ${formData.message}</p>`
        })
      });
    ...
    <section id="contact" className="py-20 bg-gray-50">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          {/* Map View */}
          <div className="rounded-2xl overflow-hidden shadow-lg h-[450px] p-4 flex items-center justify-center">
            <iframe
          ...
          {/* Contact Form */}
          <Card className="shadow-xl border-0 h-[450px] flex items-center">
